...
enum class ResponseEnum(val code: String, val httpStatus: HttpStatus, val description: String) {
    ...
    REQUEST_METHOD_NOT_SUPPORTED("E10", HttpStatus.METHOD_NOT_ALLOWED, ""),
    HTTP_MESSAGE_NOT_READABLE("E11", HttpStatus.BAD_REQUEST,
        "Malformed JSON request or missing required fields. Remember to add the request parameters or request body.")
